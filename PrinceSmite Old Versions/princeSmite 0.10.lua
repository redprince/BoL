...
PrinceSmite:addSubMenu("Draw range", "range")
    ...
    PrinceSmite.range:addParam("width", "Width of the circle", SCRIPT_PARAM_SLICE, 3, 1, 10, 0)
...
function OnDraw()
    ...
    then
        DrawCircle3D(myHero.x, myHero.y, myHero.z, 750, PrinceSmite.range.width, configToColor(PrinceSmite.range.color), PrinceSmite.range.quality)
    end
end
